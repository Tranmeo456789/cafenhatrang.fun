...
<div style="width:800px;margin: 0px auto;border: solid 1px #dbd8d8;padding:5px 20px 5px 20px">
    <div style="font-size: 14px">
        <p style="font-style: italic;font-weight: bold">Cảm ơn Quý khách <span style="font-style: normal;color:#067461" >{{$data['fullname']}}</span> đã đặt hàng tại The moonlight</p>
        <p>The moonlight rất vui được thông báo đơn hàng <span style="font-weight: bold">{{$data['code_order']}}</span> của Quý khách đã được tiếp nhận và đang trong quá trình xử lý.
        The moonlight sẽ thông báo cho Quý khách khi đơn hàng chuẩn bị giao hàng.</p>
    </div>
    ...
    <div>
        ...
        <div style="width:100%;clear:both;display:block;overflow:hidden;margin:30px 0px 0px">
            <p style="display:block;font-size:14px;color:#333333;margin:0px 0px 5px;line-height:20px"><span style="font-family:Arial,sans-serif">Nếu cần hỗ trợ, Quý khách chỉ cần gửi email đến <a href="mailto:cafenhatrang94@gmail.com" target="_blank">cafenhatrang94@<wbr>gmail.com</a> hoặc gọi số <strong>0349757794</strong>.</span></p>
