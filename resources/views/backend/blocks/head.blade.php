...
<link rel="stylesheet" href="{{ asset('template/css/icheck-bootstrap.min.css') }}">
<link rel="stylesheet" href="{{ asset('backend/css/jquery.uploadPreviewer.css') }}">
<link rel="stylesheet" href="{{ asset('template/css/summernote-bs4.css') }}">
<!-- Theme style AdminLTE v3.0.5-->
<link rel="stylesheet" href="{{ asset('template/css/adminlte.css') }}">
<link rel="stylesheet" href="{{ asset('backend/css/style.css') }}?ts={{time()}}">
<link rel="stylesheet" href="{{ asset('backend/css/my-style.css') }}?ts={{time()}}">